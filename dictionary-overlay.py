...
async def init():
    ...
    with open(knownwords_file_path, "r", encoding="utf-8") as f:
        known_words= set(f.read().split())
    with open(unknownwords_file_path, "r", encoding="utf-8") as f:
        unknown_words= set(f.read().split())
